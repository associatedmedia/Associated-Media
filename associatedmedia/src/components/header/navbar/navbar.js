                ...
                <div className="col-7">
                    <div className="cs_box_one">
                        <div className="cs_nav_black_section cs_font_changes">
                            <ul>
                                <li className="menu-item-has-black-section cs_style_1">
                    ...
                    <div className="cs_box_two">
                        <div>
                                ...
                                <Link href="tel:(406)555-0120">
                                    <svg width="35" height="35" viewBox="0 0 18 19" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="white"></path>
                                    </svg><span className="ms-2">(406)555-0120</span></Link>
                            </h4>
                            ...
                            <ul className="cs_social_link">
                                ...
                                <li><Link href="https://dribbble.com/">Dribbble</Link></li>
                            </ul>

                            <hr className="mt-2 me-5 mb-2" />
                            <h2>
                                <Link href="mailto:info@email.com" className="cs_primary_font cs_text_btn"><span
                                        className="cs_black">info@email.com</span></Link>
                            </h2>
                        </div>
                    </div>
                </div>
