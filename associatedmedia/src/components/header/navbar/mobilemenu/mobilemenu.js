...
import {mobileItems} from '@/lib/constant';
...
<div className="cs_side_header">
        ...
        <div className="cs_side_header_in">
            <Link className="cs_site_branding" href="index.html">
                    ...
                    <div className="cs_box_one">
                        <div className="cs_nav_black_section cs_font_changes">
                            <ul>
                                ...
                                <li className="menu-item-has-black-section cs_style_1" key={index}>
                    ...
                    <div className="cs_box_two">
                        <div>
                            <p>
                                ...
                                <span className="ms-2">Poloview, Srinagar, <br />
                                    &nbsp; &nbsp; &nbsp; &nbsp;J&K</span>
                            </p>
                                ...
                                <a href="tel:(406)555-0120">
                                    <svg width="35" height="35" viewBox="0 0 18 19" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="white"></path>
                                    </svg><span className="ms-2">(0194)247-9356</span></a>
                            </h4>

                            <ul className="cs_social_link">
                                <li><a href="https://www.facebook.com/associatedmediakashmir/">Facebook</a></li>
                                <li><a href="https://www.linkedin.com/company/associated-media-kash/?originalSubdomain=in">Linkedin</a></li>
                                <li><a href="https://www.instagram.com/associated_media_/?hl=en">Instagram</a></li>
                            </ul>

                            <hr className="mt-2 me-5 mb-2" />
                            <h2>
                                <a href="mailto:info@email.com" className="cs_primary_font cs_text_btn"><span
                                        className="cs_black">solutions@associatedmedia.org</span></a>
                            </h2>
                        </div>
                    </div>
                </div>
