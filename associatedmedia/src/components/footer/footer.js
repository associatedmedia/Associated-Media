...
export default function footer()
{
    ...
    <div className="setting_mode">
      <button id="open">
        <Image src="/assets/img/brightnes.svg" alt="brightness" width={30} height={30} />
      </button>
      <button id="close">
        <Image src="/assets/img/close.svg" alt="close" width={30} height={30}/>
      </button>
    </div>

    <div className="cs_mode_btn js-mode-type">
            ...
            <div className="cs_video_popup_container">
                <div className="cs_video_popup_align">
                    <div className="embed-responsive embed-responsive-16by9">
                        <iframe className="embed-responsive-item" src="about:blank"></iframe>
                    </div>
                </div>
