...
import { FORM_FIELDS, FORM_BUTTON } from '@/lib/constant';
...
export default function ContactPage()
{
  ...
  const handleSubmit = (e) => {
    ...
    // Send data to your API route here if needed
  };
    return(
        <>
    <Navbar/>
    ...
    <section>
        ...
        <div className="row">
          {FORM_FIELDS.map((field, index) => (
            <div key={index} className="cs_field_group col">
              <input
              ...
              />
              <label htmlFor={field.id} className="cs_input_label">
                {field.label}
              </label>
            </div>
          ))}
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="cs_icon">
                                    ...
                                    <div className="cs_icon_text">
                                        ...
                                        <p className="cs_icon_subtitle">Poloview, Srinagar, J&K</p>
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="cs_icon">
                                    ...
                                    <a href="tel:(0194) 247-9356" className="cs_icon_style">
                                    ...
                                    <div className="cs_icon_text">
                                        ...
                                        <p className="cs_icon_subtitle">(0194) 247-9356</p>
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="cs_icon">
                                    ...
                                    <div className="cs_icon_text">
                                        ...
                                        <p className="cs_icon_subtitle">solutions@associatedmedia.org</p>
